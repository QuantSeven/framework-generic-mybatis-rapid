...
public class DbSqlSessionFactoryBeanx implements FactoryBean<SqlSessionFactory>, InitializingBean {
	Log logger = LogFactory.getLog(DbSqlSessionFactoryBeanx.class);
	...
	private SqlSessionFactory createSqlSessionFactory() throws IOException {
		...
		try {
			...
			if (dataSource != null) {
				...
				conf.addMapper(GenericCurdTemplate.class);
